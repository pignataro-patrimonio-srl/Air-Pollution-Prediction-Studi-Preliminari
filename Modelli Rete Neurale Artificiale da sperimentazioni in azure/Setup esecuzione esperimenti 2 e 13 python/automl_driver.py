...
workspace_name = "AirPollutionPrediction" # PLACEHOLDER
subscription_id = "194e4ef4-8e27-42f0-b765-96c584b38a54" # PLACEHOLDER
resource_group = "Pignataro-Patrimonio" # PLACEHOLDER
experiment_name = "AirPollutionPrediction" # PLACEHOLDER
iteration = "99"  # PLACEHOLDER
run_id = "AutoML_720f86f4-3433-41dc-b66b-65104e345242_99"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'name':'AirPollutionPrediction','path':'./sample_projects/AirPollutionPrediction','subscription_id':'194e4ef4-8e27-42f0-b765-96c584b38a54','resource_group':'Pignataro-Patrimonio','workspace_name':'AirPollutionPrediction','region':'westeurope','iterations':100,'primary_metric':'spearman_correlation','data_script':None,'compute_target':'PPAPP','task_type':'regression','validation_size':None,'n_cross_validations':5,'y_min':None,'y_max':None,'num_classes':None,'preprocess':True,'lag_length':0,'max_cores_per_iteration':-1,'max_concurrent_iterations':6,'iteration_timeout_minutes':60,'mem_in_mb':None,'enforce_time_on_windows':True,'experiment_timeout_minutes':60,'experiment_exit_score':None,'whitelist_models':None,'blacklist_algos':['TensorFlowLinearRegressor'],'auto_blacklist':False,'blacklist_samples_reached':False,'exclude_nan_labels':True,'verbosity':20,'debug_log':'automl_errors.log','show_warnings':False,'model_explainability':False,'service_url':None,'sdk_url':None,'sdk_packages':None,'telemetry_verbosity':'INFO','send_telemetry':True,'spark_service':None,'metrics':None,'enable_ensembling':True,'ensemble_iterations':15,'enable_tf':False,'enable_cache':True,'enable_subsampling':False,'subsample_seed':None,'cost_mode':0,'metric_operation':'maximize','is_timeseries':False,'time_column_name':None,'max_horizon':None,'enable_onnx_compatible_models':False,'enable_voting_ensemble':True,'enable_stack_ensemble':True,'enable_stack_ensembling':False,'enable_early_stopping':False,'early_stopping_n_iters':10,'enable_feature_sweeping':False} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'spearman_correlation','debug_log':'automl_errors.log','verbosity':20,'ensemble_iterations':15,'is_timeseries':False,'name':'AirPollutionPrediction','compute_target':'PPAPP','subscription_id':'194e4ef4-8e27-42f0-b765-96c584b38a54','region':'westeurope','time_column_name':None,'max_horizon':None}\",\"ensemble_run_id\":\"AutoML_720f86f4-3433-41dc-b66b-65104e345242_99\",\"experiment_name\":\"AirPollutionPrediction\",\"workspace_name\":\"AirPollutionPrediction\",\"subscription_id\":\"194e4ef4-8e27-42f0-b765-96c584b38a54\",\"resource_group_name\":\"Pignataro-Patrimonio\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datastoreName\":\"airpollutionpr1955096294__azureml_blobstore_29b9fd95_adf2_4514_9ad1_92b666cbd867\",\"dataPath\":\"Pignataro Patrimonio - sede comunale (41.1893881 14.1710139) Primary 04_01_2019 04_30_2019.csv\",\"columnSeparator\":\",\",\"promoteHeader\":true,\"encoding\":\"UTF8\",\"ignoreNewlineInQuotes\":true,\"skipRows\":0,\"features\":[\"created_at\",\"entry_id\",\"PM1.0_CF_ATM_ug/m3\",\"PM2.5_CF_ATM_ug/m3\",\"PM10.0_CF_ATM_ug/m3\",\"UptimeMinutes\",\"ADC\",\"Temperature_F\",\"Humidity_%\",\"\"],\"label\":\"PM2.5_CF_1_ug/m3\"}" # PLACEHOLDER
